...
const repos: RepoSpec[] = [
  ...
  { slug: "local/anthill-cloud", git: null, local_path: "/p", archetype: "x", size_hint: "medium", primary_language: "typescript" },
...
describe("teardownTargets", () => {
  it("returns only git-cloned corpus projects that resolved a project name", () => {
    const rows = [
      ...
      { slug: "local/anthill-cloud", ok: true, project: "Users-rka-Development-anthill-cloud" },
