...
const facts = {
  ...
  hotspots: [
    { module: "mcp-server", path: "src/mcp-server", in_edges: 90, nodes: 300, governing_decisions: 8, open_todos: 2 },
    { module: "db", path: "src/db", in_edges: 60, nodes: 40, governing_decisions: 6, open_todos: 0 },
  ],
  entrypoints: [
